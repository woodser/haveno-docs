...
If you are a Whonix or Qubes OS user, you must connect through an external, static Tor instance (see below).
...
This mode allows advanced features in your external `torrc` file and is the required configuration for Whonix and Qubes OS users. See the [Static Tor](./static_onion.md) guide for extended configuration options.
